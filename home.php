...
if($lastInsertId)
{
  ...
  $msg = "Thankyou for registering the details";
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
                        ...
                        <h4 class="text-center mt-2x">Personal</h4>
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <h4 class="text-center mt-2x">Recruitment</h4><br>
                            ...
                            <div class="form-group">
                            <label class="col-sm-1 col-lg-6 control-label">Why ISTE<span style="color:red">*</span><br></label>
                            <div class="col-sm-5">
                            <textarea class="form-control" rows = "5" cols = "60" name = "text">
                            </textarea><br>
                            </div>
                            <br><br><br>
                            <label class="col-sm-1 col-lg-6 control-label">Tell us why you will be favorable for this position<span style="color:red">*</span><br></label>
                            <div class="col-sm-5">
                            <textarea class="form-control" rows = "5" cols = "60" name = "text">
                            </textarea><br>
                            </div>
